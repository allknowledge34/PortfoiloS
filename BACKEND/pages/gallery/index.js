        ...
        <div className="blogpage">
            <div className="titledashboard flex flex-sb">
                ...
                <div className="breadcrumb">
                    <TbBrandBlogger /> <span>/</span> <span>Photos</span>
                </div>
            </div>
                                    ...
                                    <tr key={blog._id}>
                                        ...
                                        <td>
                                            <div className="flex gap-2 flex-center">
                                                <Link href={'/gallery/edit/' + blog._id}><button><FaEdit /></button></Link>
                                                <Link href={'/gallery/delete/' + blog._id}><button><RiDeleteBin6Fill /></button></Link>
                                            </div>
                                        </td>
                                    </tr>
                                ))
